...
func _init() -> void:
	screens = {
		...
		SoccerGame.ScreenType.CONTROLS: preload("res://scenes/scenes/controls.tscn"),
		SoccerGame.ScreenType.ABOUT: preload("res://scenes/scenes/about.tscn"), # Necesitas crear esta escena
