extends Screen
class_name MixedQuizScreen  # Cambiar según corresponda: MixedQuizScreen, ThermoWatchQuizScreen
...
const ALL_QUIZ_DATA = {
	"mixed": [ # ✅ CLAVE AJUSTADA a "soccer" para coincidir con ScreenData
...
var quiz_mode_key: String = "mixed" # Clave predeterminada
